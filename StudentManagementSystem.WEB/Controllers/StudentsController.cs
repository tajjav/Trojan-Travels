...
namespace StudentManagementSystem.WEB.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(ApplicationDbContext context, IStudentRepository studentRepository, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public async Task<ViewResult> Index(string? firstName, string? lastName, string? gender)
        {
        ...
        public async Task<ViewResult> GetStudentCourses(int studentId)
        {
            IList<string> courseList = await _studentRepository.GetStudentCourses(studentId);
        ...
        public async Task<ActionResult> Create(CreateStudentViewModel studentVM)
        {
            try
            {
                ...
                {
                    uniqueFileName = ProcessUploadFile(studentVM);
                }
        ...
        public async Task<ActionResult> Edit(EditStudentViewModel studentVM)
        {
            try
            {
                ...
                if (studentVM.Photo != null)
                {
                    ...
                    student.ImageFile = ProcessUploadFile(studentVM);
                }
                else
                {
        ...
        private string ProcessUploadFile(CreateStudentViewModel studentVM)
        {
